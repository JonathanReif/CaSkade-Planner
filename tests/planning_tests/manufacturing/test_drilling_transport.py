...
"""
This test checks if the planner can create a plan for drilling a hole into a product and transport it to another station with MPS500. 
...
class TestDrillingTransport:
	...
	def test_create_and_solve(self):
		ontology_files = [ 
			...
			os.path.join(os.getcwd(), "capabilities", "manufacturing", "mps500", "tests", "required-capabilities", "DrillingAndTransport.ttl"), 
		...
		try:
			...
			max_happenings = 2
			planner: CaskadePlanner = CaskadePlanner("http://www.hsu-hh.de/aut/ontologies/lab/MPS500/required/DrillAndTransport#DrillAndTransport") 
...
if __name__ == '__main__':
	TestDrillingTransport().test_create_and_solve()