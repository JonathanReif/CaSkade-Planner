...
"""
This test checks if the planner can create a plan for drilling a hole into a product and before transporting to drilling module with MPS500. 
This ontology file contains two capabilities (drilling and transport) of the drilling module and conveyor module from MPS500 that is supposed to be executed in two happenings.
"""
class TestTransportDrilling:
	...
	def test_create_and_solve(self):
		ontology_files = [ 
			...
			os.path.join(os.getcwd(), "capabilities", "manufacturing", "mps500", "tests", "required-capabilities", "TransportAndDrilling.ttl"), 
		...
		try:
			...
			max_happenings = 2
			planner: CaskadePlanner = CaskadePlanner("http://www.hsu-hh.de/aut/ontologies/lab/MPS500/required/TransportAndDrill#TransportAndDrill") 
			...
			assert expected_plan.plan_steps[0].capability_appearances[0].capability_iri == "http://www.hsu-hh.de/aut/ontologies/lab/MPS500/Conveyor#ConveyorTransport", "Second capability should be ConveyorTransport"
			assert expected_plan.plan_steps[1].capability_appearances[0].capability_iri == "http://www.hsu-hh.de/aut/ontologies/lab/MPS500/DrillingModule#DrillAndCheck", "First capability should be drillAndCheck"
...
if __name__ == '__main__':
	TestTransportDrilling().test_create_and_solve()