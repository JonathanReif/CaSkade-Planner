...
from smt_planning.ontology_handling.precondition_and_effect_query import get_capability_preconditions, get_capability_effects, get_capability_preconditions_and_effects
